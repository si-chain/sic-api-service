 ...
 */
router.param('txnId', controller.loadTransaction);

router
  .route('/')
  /**
   * @api {get} v1/chain/transactions Get list of transactions
  ...
  /**
   * @api {post} v1/chain/transactions Create a new transactions
...
router
  .route('/:txnId')
  /**
   * @api {get} v1/chain/transactions/:txnId Get a Transaction
