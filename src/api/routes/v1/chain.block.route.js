...
router
  .route('/')
  /**
   * @api {get} v1/chain/blocks Get list of blocks
   * @apiDescription Get a list of blocks. This will get a list of all the irreversible blocks on
   * the  blockchain. By default, it returns the most recent 30 blocks.  You can request more or less
...
router
  .route('/:blockIdent')
  /**
   * @api {get} v1/chain/blocks/:ident Get Block
...
router
  ...
  /**
   * @api {get} v1/chain/blocks/:blockIdent/transactions Get transactions on Block
   * @apiDescription Get a list of    transactions for a given block. Using the identifying `block_id` or `block_num`
   ...
   * @apiUse CollectionParams
   *
   * @apiSuccess {Object[]} transactions List of    transactions for the block.
   *
   * @apiError (Unauthorized 401)  Unauthorized  Only authenticated users can access the data
   *
   * @apiSuccessExample {json} Success Example:
...
router
  ...
  /**
   * @api {get} v1/chain/blocks/:blockIdent/transactions/:txnId Get Transaction on Block
